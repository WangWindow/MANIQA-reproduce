...
|       :---:       |     :---:        |        :-----:         |        :-----:         |        :-----:         |
| <img width="200" src="./assets/GT.png">|<img width="200" src="./assets/dis1.png">|<img width="200" src="./assets/dis2.png">|<img width="200" src="./assets/dis3.png">|<img width="200" src="./assets/dis4.png">|
|**MOS (GT)**|**1539.1452 (1)**|**1371.4593 (2)**|**1223.4258 (3)**|**1179.6223 (4)**|
|**Ours (MANIQA)**|**0.743674 (1)**|**0.625845 (2)**|**0.504243 (3)**|**0.423222 (4)**|
| <img width="200" src="./assets/I01.png">|<img width="200" src="./assets/I01_01_02.png">|<img width="200" src="./assets/I01_06_05.png">|<img width="200" src="./assets/I01_15_05.png">|<img width="200" src="./assets/I01_01_05.png">|
|**MOS (GT)**|**4.33 (1)**|**2.27 (2)**|**1.33 (3)**|**1.1 (4)**|
|**Ours (MANIQA)**|**0.8141 (1)**|**0.2615 (2)**|**0.0871 (3)**|**0.0490 (4)**|
| <img width="200" src="./assets/kunkun.png">|<img width="200" src="./assets/bird.jpg">|<img width="200" src="./assets/dog.jpg">|<img width="200" src="./assets/ball.jpg">|<img width="200" src="./assets/people.jpg">|
...
We also conducted experiments on [LIVE](https://live.ece.utexas.edu/research/Quality/subjective.htm), [CSIQ](https://qualinet.github.io/databases/./assets/categorical_image_quality_csiq_database/), [TID2013](https://qualinet.github.io/databases/./assets/tampere_image_database_tid2013/) and [KADID-10K](http://database.mmsp-kn.de/kadid-10k-database.html) datasets.
